...
// APIClient manages communication with the App Store Connect API API v1.0.0
...
type APIClient struct {
	...
	TestFlightApi *TestFlightApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.TestFlightApi = (*TestFlightApiService)(&c.common)
