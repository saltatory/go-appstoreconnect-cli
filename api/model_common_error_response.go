...
// CommonErrorResponse Detailed error information returned in the response body whenever an API request is not successful.
type CommonErrorResponse struct {
	Errors []CommonErrorResponseErrors `json:"errors,omitempty"`
}
