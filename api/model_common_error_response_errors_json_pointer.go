...
// CommonErrorResponseErrorsJsonPointer An object containing the JSON pointer that indicates the location of the error.
type CommonErrorResponseErrorsJsonPointer struct {
