...
// BuildsResponse A response containing a list of resources.
type BuildsResponse struct {
	Data Build `json:"data"`
	Include OneOfPrereleaseVersionBetaTesterBetaBuildLocalizatonAppEncryptionDeclarationBetaAppReviewSubmissionAppBuildBetaDetail `json:"include,omitempty"`
