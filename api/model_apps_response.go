...
// AppsResponse A response containing a list of resources.
type AppsResponse struct {
	Data Build `json:"data"`
	Include OneOfBetaGroupPrereleaseVersionBetaAppLocalizationBuildBetaLicenseAgreementBetaAppReviewDetail `json:"include,omitempty"`
