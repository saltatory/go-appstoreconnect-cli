...
// BetaTesterCreateRequestDataRelationshipsBuilds struct for BetaTesterCreateRequestDataRelationshipsBuilds
type BetaTesterCreateRequestDataRelationshipsBuilds struct {
	Data []BetaTesterCreateRequestDataRelationshipsBuildsData `json:"data,omitempty"`
}
