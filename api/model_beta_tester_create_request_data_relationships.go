...
// BetaTesterCreateRequestDataRelationships The types and IDs of the related data to update.
type BetaTesterCreateRequestDataRelationships struct {
	...
	Builds BetaTesterCreateRequestDataRelationshipsBuilds `json:"builds,omitempty"`
}
